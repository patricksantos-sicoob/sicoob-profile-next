    ...
    <div className="flex h-screen flex-col">
      <header className="bg-[#00353e] text-white h-20 flex justify-around items-center">
        ...
        <div className="flex flex-row gap-3 items-center justify-center">
          <a className="text-[#7eb61d]" href="/login">Fazer login</a>
          <a className="bg-[#7eb61d] text-white p-2 rounded-md font-semibold" href="">Criar conta</a>
        </div>
      </header>
      <main className="bg-white h-full flex flex-col justify-center items-center gap-2">
        ...
        <p className="text-center">Projeto feito para fins de estudo e integração com o ambiente da corretora. <br /> A ideia é sintetizar o que aprendi nesse primeiro mês de corretora, como:</p>
        <ul className="">
          ...
          <li className="bg-[#0ba091] mb-1 p-2 rounded-md text-white flex flex-row items-center"><FaReact className="w-7 h-7 mr-2"/>Habilidades de front-end que já tinha e pude aprimorar, como React, Next.js, TailwindCSS, etc.</li>
          <li className="bg-[#0ba091] mb-1 p-2 rounded-md text-white flex flex-row items-center"><TbBrandTypescript className="w-7 h-7 mr-2"/>Fundamentos do TypeScript, tipagem estática, e suas diferenças em relação ao JavaScript.</li>
          <li className="bg-[#0ba091] mb-1 p-2 rounded-md text-white flex flex-row items-center"><IoServerOutline className="w-7 h-7 mr-2"/>Boas práticas de desenvolvimento de APIs REST com Express e NestJS, utilizando MongoDB e PostgreSQL como DB.</li>
          <li className="bg-[#0ba091] mb-1 p-2 rounded-md text-white flex flex-row items-center"><BsTerminal className="w-7 h-7 mr-2"/>Me aprimorei na criação de ambientes de desenvolvimento usando WSL e Docker.</li>
